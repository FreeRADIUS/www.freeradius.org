...
Denis Andzakovic found issues with the decryption of very
...
usually a crash of the server.

The initial report was for version 3.0. We determined that the
...
The packet decoder in FreeRADIUS ensures that the only time this
...
the trusted RADIUS environment.

We are releasing version 2.2.9 and version 3.0.10 to correct
the issue.
